    ...
    <main className="min-h-screen bg-gray-50 p-4 sm:p-8 flex justify-center">
      <div className="w-full max-w-4xl">
        <header className="mb-8 text-center">
          <h1 className="text-3xl sm:text-5xl font-bold text-gray-800">Журнал операций</h1>
          <p className="text-gray-600 mt-2">Полная история ваших финансовых решений.</p>
        </header>
        ...
        <div className="bg-white rounded-xl shadow-md p-4 sm:p-6">
          {fullLog.length > 0 ? (
            ...
            <p className="text-gray-500 text-center py-8">История операций пока пуста.</p>
          )}
        </div>
