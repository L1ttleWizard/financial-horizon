...
лидерборд = done
8. добавить интерактивные ивенты в неделю, чтобы в модалке можно было условно при выборе покрутить слоты или воздеражаться при выборе покрутить слоты крутить слоты = done
...
было бы прикольно, если бы сердечко заполнялось, когда настроение повышается и наоборот = done
