...
надо сделать в полях регистрации никнейм, чтобы он отображался в профиле и в лидерборде
денежное дерево переместить влево на сайдбар
убрать пустоты побокам
сделать достижения справа на сайдбаре вместо пустого места которое щас
доработать поле аккаунт, дать возможность менять никнейм пароль и удалять аккаунт
